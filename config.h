...
/* Define to 1 if you have the `wcpg' library (-lwcpg). */
#define HAVE_LIBWCPG 1
...
#define PACKAGE_NAME "FXPF_v1_asilomar"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "FXPF_v1_asilomar 1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "fxpf_v1_asilomar"
